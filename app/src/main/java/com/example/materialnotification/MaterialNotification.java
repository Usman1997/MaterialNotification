...
public class MaterialNotification {
    ...
    public interface TapListener {
        public void onTap(MaterialNotification warning);
    }

    public interface ClickListener {
        public void onClick(MaterialNotification warning);
    }

    public interface AnimListener {
        public void onRevealStart(MaterialNotification warning);

        public void onRevealEnd(MaterialNotification warning);

        public void onDismissStart(MaterialNotification warning);

        public void onDismissEnd(MaterialNotification warning);
    }

    public MaterialNotification setTapListener(TapListener listener) {
        this.tapListener = listener;
        return this;
    }

    public MaterialNotification setClickListener(ClickListener listener) {
        this.clickListener = listener;
        return this;
    }

    public MaterialNotification setAnimationListener(AnimListener listener) {
        this.animListener = listener;
        return this;
    }


    public static MaterialNotification init(Context context, String warningMessage,
                            ViewGroup parentLayout, WarningStyle warningStyle) {

        return new MaterialNotification(context, warningMessage, parentLayout, warningStyle);

    }

    public MaterialNotification setHeightDp(int warningHeight) {
        this.warningBoxHeight = warningHeight;
        this.rlp.height = dpToPx(warningHeight);
        return this;
    }

    public MaterialNotification setWidthDp(int warningWidth) {
        this.warningBoxWidth = warningWidth;
        this.rlp.width = dpToPx(warningWidth);
        return this;
    }

    public MaterialNotification setAlpha(float alpha) {
        this.warningBox.setAlpha(alpha);
        return this;
    }

    public MaterialNotification setHeight(ViewGroup.LayoutParams lp) {
        this.warningBoxHeight = lp.height;
        this.rlp.height = lp.height;
        return this;
    }

    public MaterialNotification setWidth(ViewGroup.LayoutParams lp) {
        this.warningBoxWidth = lp.width;
        this.rlp.width = lp.width;
        return this;
    }

    public MaterialNotification tapToDismiss(boolean tapToDismiss) {
    ...
    public MaterialNotification setAnimation(RevealAnim reveal, DismissAnim dismiss, int revealTime, int dismissTime) {
    ...
    public MaterialNotification setWarningBoxRadius(float topLeftRadius, float topRightRadius,
    ...
    public MaterialNotification setShadowColor(String htmlColor) {
    ...
    public MaterialNotification setWarningBoxBgColor(String htmlColor) {
    ...
    public MaterialNotification setWarningTappedColor(String htmlColor) {
        this.tappedColor = htmlColor;
        return this;
    }

    public MaterialNotification setWarningBoxShadow(float shadowRadius, float shadowOffsetX, float shadowOffsetY, String color) {
    ...
    public MaterialNotification setWarningInset(float warningInsetLeft, float warningInsetUp, float warningInsetRight, float warningInsetBottom) {
    ...
    public MaterialNotification hasShadow(boolean hasShadow) {
    ...
    public MaterialNotification setWarningBoxPosition(WarningPos position) {
    ...
    public MaterialNotification setWarningBoxPaddings(int left, int top, int right, int bottom) {
        int l = dpToPx(left);
        int r = dpToPx(right);
        int u = dpToPx(top);
        int d = dpToPx(bottom);
    ...
    public MaterialNotification setWarningBoxMargins(int left, int top, int right, int bottom) {
        int l = dpToPx(left);
        int r = dpToPx(right);
        int u = dpToPx(top);
        int d = dpToPx(bottom);
    ...
    public MaterialNotification setWarningText(String warningMessage) {
        this.warningMessage = warningMessage;
        this.tvWarning.setText(warningMessage);
        return this;
    }

    public MaterialNotification setWarningTextStyle(TextStyle textStyle) {
    ...
    public MaterialNotification setWarningTextMaxLines(int lines) {
    ...
    public MaterialNotification setActionText(String actionMessage) {
        this.actionText = actionMessage;
        tvAction.setText(actionMessage);
        return this;
    }

    public MaterialNotification setActionTextStyle(TextStyle textStyle) {
    ...
    public MaterialNotification setActionTextSizeDp(float size) {
        this.actionTextSize = size;
        this.tvAction.setTextSize(dpToPx(size));
        return this;
    }

    public MaterialNotification setActionTextSizeSp(float size) {
        this.tvAction.setTextSize(TypedValue.COMPLEX_UNIT_SP, size);
        this.actionTextSize = this.tvAction.getTextSize();
        return this;
    }

    public MaterialNotification setActionTextColor(String htmlColor) {
        this.tvAction.setTextColor(Color.parseColor(htmlColor));
        return this;
    }

    public MaterialNotification setActionFont(String fontPath) {
    ...
    public MaterialNotification setActionMaxLines(int lines) {
        this.actionTextMaxLines = lines;
        this.tvAction.setMaxLines(lines);
        return this;
    }

    public MaterialNotification setActionPressedColor(String htmlColor) {
        this.actionTextPressedColor = htmlColor;
        return this;
    }

    // Show warning
    public MaterialNotification show() {
    ...
    private void attachAnimListener() {
        this.revealAnimation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationStart(Animation animation) {
                if (animListener != null) {
                    animListener.onRevealStart(MaterialNotification.this);
                }
            }
            ...
            public void onAnimationEnd(Animation animation) {
                if (animListener != null) {
                    animListener.onRevealEnd(MaterialNotification.this);
                }
            }
        ...
        this.dismissAnimation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationStart(Animation animation) {
                if (animListener != null) {
                    animListener.onDismissStart(MaterialNotification.this);
                }
            }
            ...
            public void onAnimationEnd(Animation animation) {
                if (animListener != null) {
                    animListener.onDismissEnd(MaterialNotification.this);
                }
